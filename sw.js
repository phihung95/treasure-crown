...
const SHELL = [
  ...
  './js/data/store.js', './js/data/memstore.js', './js/data/api.js', './js/data/sync.js', './js/data/auth.js', './js/data/drafts.js', './js/data/shownames.js', './js/data/sources.js', './js/data/demodata.js',
